...
function App() {
  ...
  const exportImage = () =>
    html2canvas(document.querySelector("#uploadedImage")).then((canvas) => {
  ...
  return (
    <div className="App">
      ...
      <div>
        ...
        <button id="imageDelete" onClick={deleteImage}>
          Delete Loaded Image
        </button>
        <button id="imageExport" onClick={exportImage}>
          Snapshot Image
        </button>
      </div>

      <div>
        <div style={{ display: "inline-block" }}>{displayArea}</div>
